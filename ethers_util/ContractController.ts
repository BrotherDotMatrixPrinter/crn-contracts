...
export default class ContractController {
	...
	private _hasClaimed = async ( log: boolean = false ): ContractResponse< boolean > => {

		try {

			const res = await this.functions.CrnDistribution.HasClaimed( this.walletAddress )
	...
	hasClaimed = async ( log: boolean = false ): ContractResponse< boolean > =>
		ContractController.attempt< boolean >( (): ContractResponse< boolean > => this._hasClaimed( log ) )
